#!/usr/bin/env python3
"""Rewrite src/data/rhodesIslandProgram.js from edited narrative (introduction + whatToSee)."""
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parent.parent
OUT = ROOT / "src/data/rhodesIslandProgram.js"

INTRO = """ΡΟΔΟΣ ΤΟ ΝΗΣΙ ΤΩΝ ΙΠΠΟΤΩΝ
...
def main():
    header = "// Shared Rhodes island narrative (package 68 · summer catalogue).\n"
    body = (
        "export const rhodesIslandProgram = {\n"
        f"  introduction: {json.dumps(INTRO, ensure_ascii=False)},\n"
        f"  whatToSee: {json.dumps(WHAT, ensure_ascii=False)}\n"
        "}\n"
    )

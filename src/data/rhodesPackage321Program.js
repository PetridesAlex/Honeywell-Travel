/** Program copy for package 321 (ΡΟΔΟΣ – 8 Μέρες). */
export const rhodesPackage321Program = {
  introduction: `ΡΟΔΟΣ ΤΟ ΝΗΣΙ ΤΩΝ ΙΠΠΟΤΩΝ
...
Η Παλιά Πόλη της Ρόδου, το Μανδράκι, η Ακρόπολη της Λίνδου, η αρχαία Κάμειρος και η αρχαία Ιαλυσός, η Κοιλάδα με τις Πεταλούδες, η Φιλέρημος. Ιστορία μεγάλη και αξιοθέατα αναρίθμητα. Στα Δωδεκάνησα, θα συναντήσετε ένα νησί και μια φύση... σκανδαλωδώς γενναιόδωρη. Τεράστιες αμμώδεις παραλίες, σμαραγδένια νερά, κάστρα και αρχαίες πολιτείες, γκουρμέ εστιατόρια, αλλά και ταβερνάκια με σαλάτες που φτιάχνονται με υλικά από τον μπαξέ, πολυτελή ξενοδοχεία και χωριά, όπου οι γυναίκες ψήνουν ακόμη το ψωμί στον ξυλόφουρνο.
...
Αναχωρήσεις (τιμοκατάλογος): 10/07, 17/07, 24/07, 31/07, 07/08, 14/08, 21/08.
Διάρκεια: 8 μέρες / 7 διανυκτερεύσεις.
Πτήσεις Aegean Airlines: A3 496 Λάρνακα – Ρόδος 06:40–07:40 · A3 497 Ρόδος – Λάρνακα 13:00–14:00 · επιβεβαιώνονται κατά την κράτηση.`,

  whatToSee: `Αξίζει να δείτε στη Ρόδο

Παλιά Πόλη της Ρόδου: παγκόσμια κληρονομιά, ανεκτίμητη
...
Σύμφωνα με μια παράδοση κάποτε στη θέση των ελαφιών στο λιμάνι στεκόταν ο Κολοσσός. Τα πλοία έπλεαν κάτω από τα πόδια του και το πέρασμα έκλεινε τα βράδια με αλυσίδα. Από τις εντυπωσιακότερες «ιστορίες» που έχει να σας αφηγηθεί νησί στο Αιγαίο!
...
Σε ένα καταπράσινο φαράγγι, μήκους περίπου 1 χλμ., υπάρχει ένα μοναδικό στην Ελλάδα δάσος με «ζητιές», δέντρα που μοιάζουν με πλατάνια. Η μυρωδιά του χυμού που εκκρίνουν προσελκύει εκατομμύρια πεταλούδες του είδους Panaxia quadripunctaria, με τις χαρακτηριστικές τέσσερις πορτοκαλί βούλες σε κάθε φτερό. Ένας παράδεισος τον οποίον θα επισκεφθείτε με προσοχή, για να μην τρομάξετε τις πεταλούδες… Αυτό το ελληνικό νησί θα σας κλέψει την καρδιά!
...
Οι κρυμμένοι θησαυροί της Ρόδου
...
Και κάτι ακόμη: Από την Ρόδο αναχωρούν καθημερινά καραβάκια που πραγματοποιούν ημερήσιες εκδρομές στη πανέμορφη Σύμη, ένα νησί που χάρη στη μοναδική του κομψότητα και την ιδιαίτερη ατμόσφαιρα έχει γίνει η νέα πατρίδα για δεκάδες ανθρώπους από όλο τον κόσμο. Όταν φθάσετε με το πλοίο της γραμμής θα σας υποδεχθούν τα «ανθρωπόμορφα» αρχοντικά του μοναδικού, πολύχρωμου, διατηρητέου νεοκλασικού οικισμού. Στις γραφικές ταβέρνες και εστιατόρια θα γευθείτε το τοπικό συμιακό γαριδάκι,το οποίο είναι ξακουστό στην περιοχή. Στο νησί βρίσκετε επίσης Ο Ταξιάρχης Μιχαήλ ο Πανορμίτης. Εδώ οι προσκυνητές κάνουν ουρά, αλλά η αναμονή αξίζει: η ενέργεια είναι διάχυτη στο ναό. Διάσημος για τα θαύματά του ο Πανορμίτης αποτελεί μεγάλο προσκύνημα στο Αιγαίο. Η Μονή υπάρχει από τον 15ο αιώνα και η εικόνα του Ταξιάρχη Μιχαήλ θεωρείται θαυματουργή.... Το σκέφτεστε;`,
}
